	...
	public static void main(String[] args) {
		try {
			if (args.length < 1) {
				...
				sb.append("\n\t"+ AirbnbSimulator.class.getSimpleName()+": Simulate Twitter stream [3 producers]");
				sb.append("\n\t"+ AirbnbFilter.class.getSimpleName()+": Find and print records with earthquake keywords [consumer]");
