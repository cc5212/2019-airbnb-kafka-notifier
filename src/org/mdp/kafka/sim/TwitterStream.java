...
public class TwitterStream implements Runnable {
	...
	public final SimpleDateFormat LISTING_DATE = new SimpleDateFormat("yyyy-MM-dd");
			...
			while((line = br.readLine())!=null){
				...
				if(tabs.length>id){
					try{
						...
						System.err.println("Cannot parse date "+tabs[1]);
					}
				}
	...
	public long getUnixTime(String dateTime) throws ParseException{
		Date d = LISTING_DATE.parse( dateTime );
		return d.getTime();
	}
}
